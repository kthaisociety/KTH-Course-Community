...
export function About() {
  return (
    <div className="@container">
      {/* The artboard's shared content column: capped at 1216px with 20px of
          side padding. Below `@2xl` the column gives that padding up — the
          sections inside already carry the header's own 28px, and 48px a side
        ...
        <div className="px-7">
          <section className="mt-[30px] rounded-[12px] border border-cc-rule bg-cc-surface px-[22px] py-5">
            ...
            <p className="m-0 mt-3.5 text-[13.5px] text-cc-ink2 leading-[1.6]">
              ...
              matched — is open for anyone to read, fork, or improve. If
              something looks wrong or you'd rather build it differently, open
