        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-card p-8 rounded-lg shadow-sm border border-border mb-8">
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2">
              <li>Browse comprehensive course reviews from fellow students</li>
              <li>
          ...
          <div className="bg-card p-8 rounded-lg shadow-sm border border-border">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              contributing with new features or fixes for this platform you are
              very welcome to do so via the officialt KTH Course Community
              GitHub!
            </p>
          </div>
        </div>
