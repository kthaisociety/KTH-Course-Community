...
export const schoolOf = (course) =>
  course ? DEPARTMENT_SCHOOL[course.departmentCode] || "KTH" : null;
...
const round = (code, startTerm, periodLabel, extra) => ({
  ...
  studyPace: 50,
  language: "English",
  tutoringForm: "Normal daytime",
  tutoringTimeOfDay: "Daytime",
  schemaUrl: "https://www.kth.se/schema",
  isPu: false,
  isVu: false,
  ...(extra || {}),
});
...
export const courses = [
  ...
  {
    code: "SK1105",
    nameSwedish: "Experimentell fysik",
    nameEnglish: "Experimental Physics",
    ...
    eligibility: null,
    rounds: [
      round("16762", 20261, "P4 (4,0 hp)", {
        studyPace: 25,
        schemaUrl:
          "https://www.kth.se/social/course/SK1105/subgroup/vt-2026-254/calendar/",
        language: "Svenska",
        tutoringForm: "NML",
        tutoringTimeOfDay: "DAG",
        isPu: true,
        isVu: false,
      }),
    ],
  ...
  {
    code: "SF1683",
    nameSwedish: "Differentialekvationer och transformmetoder",
    ...
    eligibility: null,
    rounds: [
      round("16262", 20252, "P1 (5,0 hp), P2 (4,0 hp)", {
        studyPace: 33,
        schemaUrl:
          "https://www.kth.se/social/course/SF1683/subgroup/ht-2025-873/calendar/",
        language: "Svenska",
        tutoringForm: "NML",
        tutoringTimeOfDay: "DAG",
        isPu: true,
  ...
  {
    code: "SF1544",
    nameSwedish: "Numeriska metoder, grundkurs IV",
    ...
    eligibility: null,
    rounds: [
      round("17159", 20252, "P2 (1,0 hp)", {
        studyPace: 17,
        schemaUrl:
          "https://www.kth.se/social/course/SF1544/subgroup/ht-2025-ctfys2clgym/calendar/",
        language: "Svenska",
        tutoringForm: "NML",
        tutoringTimeOfDay: "DAG",
        isPu: true,
  ...
  {
    code: "DD1327",
    nameSwedish: "Grundläggande datalogi",
    ...
    eligibility: null,
    rounds: [
      round("16197", 20261, "P4 (6,0 hp)", {
        studyPace: 33,
        schemaUrl:
          "https://www.kth.se/social/course/DD1327/subgroup/vt-2026-grudat26/calendar/",
        language: "Svenska",
        tutoringForm: "NML",
        tutoringTimeOfDay: "DAG",
        isPu: true,
  ...
  {
    code: "SA2001",
    nameSwedish: "Hållbar utveckling och forskningsmetodik inom matematik",
    nameEnglish:
    ...
    departmentCode: "SA",
    department: "Mathematics",
    educationLevelCode: "ADVANCED",
    gradeScaleCode: "PF",
    goals: null,
    content: null,
    eligibility: null,
    rounds: [
      round("17337", 20261, "P3 (3,0 hp)", {
        studyPace: 25,
        schemaUrl:
          "https://www.kth.se/social/course/SA2001/subgroup/vt-2026-131/calendar/",
        language: "Engelska",
        tutoringForm: "NML",
        tutoringTimeOfDay: "DAG",
        isPu: true,
  ...
  {
    code: "SF2524",
    nameSwedish: "Matrisberäkningar för storskaliga system",
    ...
    eligibility: null,
    rounds: [
      round("17235", 20252, "P2 (7,5 hp)", {
        studyPace: 50,
        schemaUrl:
          "https://www.kth.se/social/course/SF2524/subgroup/ht-2025-1036/calendar/",
        language: "Engelska",
        tutoringForm: "NML",
        tutoringTimeOfDay: "DAG",
        isPu: true,
  ...
  {
    code: "DD1337",
    nameSwedish: "Programmering",
    nameEnglish: "Programming",
    ...
    gradeScaleCode: "AF",
    goals:
      "Write, read and debug small programs in a statically typed language.",
    content:
      "Values and types, control flow, data structures, files, testing and version control.",
    eligibility: "None",
    rounds: [round("1", "HT2024", "P1–P2"), round("1", "HT2025", "P1–P2")],
  },
  {
    code: "DD1338",
    nameSwedish: "Algoritmer och datastrukturer",
    nameEnglish: "Algorithms and Data Structures",
    ...
    gradeScaleCode: "AF",
    goals:
      "Choose and analyse data structures and algorithms by asymptotic cost.",
  ...
  {
    code: "DD2380",
    nameSwedish: "Artificiell intelligens",
    ...
    gradeScaleCode: "AF",
    goals:
      "Model a problem as search, constraint satisfaction or probabilistic inference.",
    content:
      "Search, adversarial games, constraint satisfaction, probabilistic reasoning, three labs.",
    eligibility: "DD1337 and SF1626",
    rounds: [round("1", "HT2025", "P2")],
  },
  {
    code: "DD2421",
    nameSwedish: "Maskininlärning",
    ...
    gradeScaleCode: "AF",
    goals:
      "Pick, train and evaluate a supervised model, and say why it generalises.",
    content:
      "Decision trees, SVMs, boosting, Bayesian learning, weekly assignments in Python.",
    eligibility: "SF1626 and SF1918",
    rounds: [round("1", "HT2025", "P2")],
  },
  {
    code: "DD2424",
    nameSwedish: "Djupinlärning i datavetenskap",
    nameEnglish: "Deep Learning in Data Science",
    ...
    content:
      "Four numpy assignments before any framework, then an open project.",
    eligibility: "DD2421 or equivalent",
    rounds: [round("1", "HT2025", "P2"), round("1", "VT2026", "P3")],
  },
  {
    code: "DD2437",
    nameSwedish: "Artificiella neuronnät och djupa arkitekturer",
    ...
    content:
      "Perceptrons, RBF networks, Hopfield nets, deep architectures, lab series.",
    eligibility: "SF1624 and programming experience",
    rounds: [round("1", "HT2026", "P1–P2")],
  },
  {
    code: "DD2412",
    nameSwedish: "Djupinlärning, avancerad kurs",
    nameEnglish: "Deep Learning, Advanced Course",
  ...
  {
    code: "SF1624",
    nameSwedish: "Algebra och geometri",
    nameEnglish: "Algebra and Geometry",
  ...
  {
    code: "SF1626",
    nameSwedish: "Flervariabelanalys",
    nameEnglish: "Calculus in Several Variables",
    ...
    content:
      "Partial derivatives, optimisation, multiple integrals, vector fields.",
    eligibility: "One-variable calculus",
    rounds: [round("1", "VT2025", "P3–P4")],
  },
  {
    code: "SF1918",
    nameSwedish: "Sannolikhetsteori och statistik",
    nameEnglish: "Probability Theory and Statistics",
    ...
    content:
      "Distributions, estimation, confidence intervals, hypothesis testing, labs.",
    eligibility: "SF1626",
    rounds: [round("1", "HT2025", "P1")],
  },
  {
    code: "AK2030",
    nameSwedish: "Teori och metod i vetenskapsstudier",
  ...
  {
    code: "DD2434",
    nameSwedish: "Maskininlärning, avancerad kurs",
    nameEnglish: "Machine Learning, Advanced Course",
    ...
    content:
      "Probabilistic modelling from the ground up: latent variable models, variational inference and sampling, assessed by exam and a paper-reproduction project.",
    eligibility: "DD2421",
    rounds: [round("1", "VT2026", "P3")],
  },
  {
    code: "SF2955",
    nameSwedish: "Datorintensiva metoder i matematisk statistik",
    ...
    gradeScaleCode: "AF",
    goals:
      "Choose a simulation method for an inference problem and justify it.",
    content:
      "Simulation-based inference: Monte Carlo, resampling and sequential methods, taught entirely through three long home assignments.",
    eligibility: "SF1918",
    rounds: [round("1", "VT2026", "P3–P4")],
  },
  {
    code: "SF2942",
    nameSwedish: "Portföljteori och riskvärdering",
    nameEnglish: "Portfolio Theory and Risk Management",
    ...
    content:
      "Mean-variance portfolios, utility and coherent risk measures, with hand-ins that use real return series.",
    eligibility: "SF1918",
    rounds: [round("1", "HT2025", "P2")],
  },
  {
    code: "DH2642",
    nameSwedish: "Interaktionsprogrammering och den dynamiska webben",
    ...
    state: "ESTABLISHED",
    departmentCode: "DH",
    department: "Human Centered Technology",
    educationLevelCode: "ADVANCED",
    gradeScaleCode: "AF",
    goals: "Build a web client in a group and defend its interaction design.",
    content:
      "Builds a real web client in a group of four, with seminars on interaction patterns and two rounds of peer evaluation.",
    eligibility: "DD1337",
    rounds: [round("1", "HT2025", "P1–P2")],
  },
  {
    code: "EQ2300",
    nameSwedish: "Digital signalbehandling",
    nameEnglish: "Digital Signal Processing",
    ...
    content:
      "Discrete-time filters, sampling theory and spectral estimation, with weekly hand-ins feeding a written exam.",
    eligibility: "SF1626",
    rounds: [round("1", "HT2025", "P2")],
  },
  {
    code: "EQ1110",
    nameSwedish: "Signaler och system",
    nameEnglish: "Signals and Systems",
...
export const userTakenCourses = [
  {
    ...
    attendanceYear: "HT2024",
    grade: "A",
    earnedCredits: 7.5,
    transcriptImportedAt: "2026-08-24T09:12:00Z",
...
export const reviews = [
  {
    ...
    happyTook: true,
    message:
      "Do the assignments the week they open. The exam leans on the same derivations you meet there, so an assignment you rushed is an exam question you cannot answer.",
  ...
  },
  {
    ...
    approachTheoryPercent: 45,
    workloadScore: 6,
    learningScore: 7,
    happyTook: true,
    message:
      "The project carries the course, so pick a group early. Search and planning are covered well; the probabilistic parts go fast.",
  ...
  },
  {
    ...
    approachTheoryPercent: 90,
    workloadScore: 9,
    learningScore: 5,
    happyTook: false,
    message:
      "One exam, nothing else, and the practice exams are the only real preparation. Work old exams from week one rather than the textbook problems.",
  ...
  },
  {
    ...
    happyTook: true,
    message:
      "Light on hours and genuinely useful if you have never run a project. Take it in a term where your other courses are heavy.",
  ...
  },
  {
    ...
    happyTook: false,
    message:
      "Pass or fail, and the essay is the whole thing. Write about something from your own field or the reading becomes a slog.",
  ...
  },
  {
    ...
    approachTheoryPercent: 55,
    workloadScore: 9,
    learningScore: 10,
    happyTook: true,
    message:
      "Four assignments in plain numpy before any framework shows up, and that is why the course works. Budget a full weekend per assignment.",
  ...
  },
  {
    ...
    approachTheoryPercent: 75,
    workloadScore: 5,
    learningScore: 7,
    happyTook: true,
    message:
      "Straightforward and well organised. Take it before machine learning if you can choose the order.",
  ...
  },
  {
    ...
    happyTook: true,
    message:
      "Assignments are graded on complexity, not on whether it runs, so read the requirements twice before writing anything.",
  ...
  },
  {
    ...
    approachTheoryPercent: 85,
    workloadScore: 8,
    learningScore: 6,
    happyTook: false,
    message:
      "Heavy maths and a fast pace. Doable, but only if calculus is fresh.",
...
export const courseMetrics = {
  DD2380: {
    reviewCount: 214,
    writtenReviewCount: 154,
    enrolledCount: 1180,
    happyAnswerCount: 38,
    themeLine: "Start the labs early; rewarding",
    missingNote: null,
    averageWorkloadScore: 7.4,
    averageLearningScore: 8.1,
    happyTookPercent: 82,
    averageTheoryPercent: 58,
    examinationDistribution: {
      exam: 34,
      assignments: 29,
      labs: 37,
  ...
  DD2421: {
    reviewCount: 341,
    writtenReviewCount: 246,
    enrolledCount: 1640,
    happyAnswerCount: 57,
    themeLine: "Lab 2 is the whole course",
    missingNote: null,
    averageWorkloadScore: 6.8,
    averageLearningScore: 8.8,
    happyTookPercent: 91,
    averageTheoryPercent: 46,
    examinationDistribution: {
      exam: 22,
      assignments: 60,
      labs: 18,
  ...
  DD2424: {
    reviewCount: 96,
    writtenReviewCount: 69,
    enrolledCount: 940,
    happyAnswerCount: 44,
    themeLine: "The hardest course I took, but worth it",
    missingNote: null,
    averageWorkloadScore: 9.0,
    averageLearningScore: 9.6,
    happyTookPercent: 88,
    averageTheoryPercent: 55,
    examinationDistribution: {
      exam: 0,
      assignments: 60,
      labs: 0,
  ...
  DD1337: {
    reviewCount: 402,
    writtenReviewCount: 289,
    enrolledCount: 2450,
    happyAnswerCount: 96,
    themeLine: "Start the assignments the week they open",
    missingNote: null,
    averageWorkloadScore: 6.2,
    averageLearningScore: 8.0,
    happyTookPercent: 86,
    averageTheoryPercent: 35,
    examinationDistribution: {
      exam: 40,
      assignments: 40,
      labs: 20,
  ...
  DD1338: {
    reviewCount: 288,
    writtenReviewCount: 207,
    enrolledCount: 1720,
    happyAnswerCount: 74,
    themeLine: "Complexity, not correctness, is graded",
    missingNote: null,
    averageWorkloadScore: 7.8,
    averageLearningScore: 9.0,
    happyTookPercent: 84,
    averageTheoryPercent: 60,
    examinationDistribution: {
      exam: 50,
      assignments: 50,
      labs: 0,
  ...
  SF1624: {
    reviewCount: 356,
    writtenReviewCount: 256,
    enrolledCount: 2600,
    happyAnswerCount: 91,
    themeLine: "Old exams are the preparation",
    missingNote: null,
    averageWorkloadScore: 7.0,
    averageLearningScore: 7.2,
    happyTookPercent: 71,
    averageTheoryPercent: 88,
    examinationDistribution: {
      exam: 90,
      assignments: 10,
      labs: 0,
  ...
  SF1626: {
    reviewCount: 331,
    writtenReviewCount: 238,
    enrolledCount: 2380,
    happyAnswerCount: 84,
    themeLine: "One exam and nothing else",
    missingNote: null,
    averageWorkloadScore: 8.6,
    averageLearningScore: 6.4,
    happyTookPercent: 54,
    averageTheoryPercent: 90,
    examinationDistribution: {
      exam: 100,
      assignments: 0,
      labs: 0,
  ...
  SF1918: {
    reviewCount: 274,
    writtenReviewCount: 197,
    enrolledCount: 2310,
    happyAnswerCount: 88,
    themeLine: "The lectures help, but old exams are essential",
    missingNote: null,
    averageWorkloadScore: 6.0,
    averageLearningScore: 7.6,
    happyTookPercent: 79,
    averageTheoryPercent: 75,
    examinationDistribution: {
      exam: 80,
      assignments: 0,
      labs: 20,
  ...
  AK2030: {
    reviewCount: 118,
    writtenReviewCount: 85,
    enrolledCount: 690,
    happyAnswerCount: 28,
    themeLine: "The seminars are the better half",
    missingNote: null,
    averageWorkloadScore: 4.4,
    averageLearningScore: 4.8,
    happyTookPercent: 41,
    averageTheoryPercent: 80,
    examinationDistribution: {
      exam: 0,
      assignments: 0,
      labs: 0,
  ...
  ME2053: {
    reviewCount: 143,
    writtenReviewCount: 103,
    enrolledCount: 880,
    happyAnswerCount: 33,
    themeLine: "Light load, useful in practice",
    missingNote: null,
    averageWorkloadScore: 4.0,
    averageLearningScore: 6.2,
    happyTookPercent: 77,
    averageTheoryPercent: 25,
    examinationDistribution: {
      exam: 0,
      assignments: 0,
      labs: 0,
  ...
  EQ1110: {
    reviewCount: 87,
    writtenReviewCount: 63,
    enrolledCount: 520,
    happyAnswerCount: 19,
    themeLine: "Only worth it with fresh calculus",
    missingNote: null,
    averageWorkloadScore: 8.4,
    averageLearningScore: 6.6,
    happyTookPercent: 58,
    averageTheoryPercent: 85,
    examinationDistribution: {
      exam: 100,
      assignments: 0,
      labs: 0,
  ...
  DD2434: {
    ...
    enrolledCount: 410,
    happyAnswerCount: 17,
    themeLine: "Maths-first; read ahead",
    missingNote: null,
    averageWorkloadScore: 8.8,
    averageLearningScore: 7.9,
    happyTookPercent: 68,
    averageTheoryPercent: 82,
    examinationDistribution: {
      exam: 58,
      assignments: 0,
      labs: 0,
  ...
  SF2955: {
    ...
    enrolledCount: 330,
    happyAnswerCount: 14,
    themeLine: "Do the hand-ins with someone",
    missingNote: "No examination breakdown yet",
    averageWorkloadScore: 7.6,
    averageLearningScore: 8.1,
    happyTookPercent: 79,
    averageTheoryPercent: 64,
    examinationDistribution: null,
  },
  SF2942: {
    reviewCount: 118,
    ...
    enrolledCount: 470,
    happyAnswerCount: 21,
    themeLine: "Clear lectures, light load",
    missingNote: null,
    averageWorkloadScore: 4.6,
    averageLearningScore: 7.0,
    happyTookPercent: 81,
    averageTheoryPercent: 68,
    examinationDistribution: {
      exam: 64,
      assignments: 0,
      labs: 0,
  ...
  DH2642: {
    reviewCount: 176,
    writtenReviewCount: 127,
    enrolledCount: 820,
    happyAnswerCount: 31,
    themeLine: "Pick your group in week one",
    missingNote: null,
    averageWorkloadScore: 6.4,
    averageLearningScore: 7.4,
    happyTookPercent: 84,
    averageTheoryPercent: 28,
    examinationDistribution: {
      exam: 0,
      assignments: 0,
      labs: 0,
  ...
  EQ2300: {
    ...
    themeLine: "Do the hand-ins with someone",
    missingNote: null,
    averageWorkloadScore: 8.2,
    averageLearningScore: 7.3,
    happyTookPercent: 71,
    averageTheoryPercent: 76,
    examinationDistribution: {
      exam: 70,
      assignments: 30,
      labs: 0,
  ...
  DD2437: {
    ...
    enrolledCount: 560,
    happyAnswerCount: 0,
    themeLine: "No themes yet",
    missingNote: "No reviews yet",
    averageWorkloadScore: null,
    averageLearningScore: null,
    happyTookPercent: null,
    averageTheoryPercent: null,
    examinationDistribution: null,
  },
  DD2412: {
    reviewCount: 4,
    ...
    enrolledCount: 120,
    happyAnswerCount: 4,
    themeLine: "Reading-heavy, small cohort",
    missingNote: "Not enough reviews for an examination split",
    averageWorkloadScore: 8.0,
    averageLearningScore: 9.0,
    happyTookPercent: null,
    averageTheoryPercent: null,
    examinationDistribution: null,
...
export const likedReviewIds = (userId) =>
  (loadLikedReviews()[userId] || []).slice();
export function setLikedReviewIds(userId, ids) {
  const all = loadLikedReviews();
  all[userId] = ids.slice();
  try {
    window.localStorage.setItem(LIKED_REVIEWS_KEY, JSON.stringify(all));
  } catch (e) {}
}

function loadTakenOverrides() {
  try {
    return JSON.parse(window.localStorage.getItem(TAKEN_OVERRIDES_KEY) || "{}");
  } catch (e) {
    return {};
  }
}
...
export function setTakenOverride(userId, code, patch) {
  ...
  try {
    window.localStorage.setItem(TAKEN_OVERRIDES_KEY, JSON.stringify(overrides));
  } catch (e) {
    /* storage off */
  }
  const row = userTakenCourses.find(
    (r) => r.userId === userId && r.courseCode === code,
  );
...
export const transcriptImports = {
  first: {
    fileName: "resultatintyg-2026-08-24.pdf",
    fileSize: "412 KB",
    pageCount: 3,
    readAt: "2026-08-24",
    rows: userTakenCourses
      .map((r) => ({ ...r }))
      .concat([
        {
          userId: "u1",
          courseCode: "MJ2426",
          courseName: "Sustainable Energy Utilisation",
          attendancePeriods: ["P3"],
          attendanceYear: "VT2026",
          grade: "B",
          earnedCredits: 7.5,
        ...
        },
        {
          userId: "u1",
          courseCode: null,
          courseName: "Machine Perception (exchange, KU Leuven)",
          attendancePeriods: ["P4"],
          attendanceYear: "VT2026",
          grade: "P",
          earnedCredits: 6,
  ...
  second: {
    fileName: "resultatintyg-2027-01-18.pdf",
    fileSize: "438 KB",
    pageCount: 3,
    readAt: "2027-01-18",
    rows: [
...
export const collections = [
  {
    id: "c1",
    name: "Autumn electives",
    codes: ["DD2424", "DD2412", "DD2437"],
    updated: "2 days ago",
  },
  {
    id: "c2",
    name: "Might swap for ML",
    codes: ["DD2421", "DD2380"],
    updated: "1 week ago",
  },
  {
...
export function removeCourseFromCollection(id, code) {
  const c = collections.find((x) => x.id === id);
  if (c) {
    c.codes = c.codes.filter((k) => k !== code);
    c.updated = "just now";
  }
  return c || null;
}
...
export const prerequisitesOf = (code, locale) =>
  coursePrerequisites
    ...
    .map((p) => {
      ...
      return {
        code: p.prerequisiteCourseCode,
        name: c ? courseName(c, locale) : null,
        inCatalog: Boolean(c),
      };
    });
...
export const termOrder = (value) => {
  ...
  if (!l) return 0;
  const y = Number.parseInt(l.slice(2), 10) + 2000;
...
export function yearOf(value) {
  ...
  if (m) return 2000 + Number.parseInt(m[1], 10);
  m = /^(\d{4})[12]?$/.exec(s);
  if (m) return Number.parseInt(m[1], 10);
  return null;
}
...
(function seedGraph() {
  ...
  usersNodeProfiles.u1 = {
    userId: "u1",
    color: "#2f9e8e",
    style: "ring",
    signalStyle: "comet",
  };
  usersNodeProfiles.u9 = {
    userId: "u9",
    color: "#dfa53c",
    style: "solid",
    signalStyle: "fade",
  };
  usersNodeProfiles.u7 = {
    userId: "u7",
    color: "#6a4ea8",
    style: "diamond",
    signalStyle: "dashed",
...
export const graphNode = (userId) =>
  usersGraphNodes.find((n) => n.userId === userId) || null;
...
export function graphNeighborhood(userId, max) {
  ...
  const edges = usersGraphBackboneEdges.filter(
    (e) => inSet[e.nodeUserId] && inSet[e.anchorUserId],
  );
  return {
...
export const earnedTier = (userId) => {
  ...
  return u && u.personalizationTierEarned != null
    ? u.personalizationTierEarned
    : 0;
};
...
export function setPersonalization(userId, patch) {
  ...
  try {
    window.localStorage.setItem(PERSONALIZATION_KEY, JSON.stringify(all));
  } catch (e) {}
}
...
export function effectiveTier(userId, now) {
  ...
  const latest = mine
    ...
    .sort((a, b) => b - a)[0];
  const months =
    ((now ? new Date(now) : new Date()).getTime() - latest) / 2592000000;
...
export const courseRound = (course, startTerm) => {
  ...
  return (
    course.rounds.find((r) => r.startTerm === startTerm) ||
    course.rounds[course.rounds.length - 1]
  );
};
...
export function metricsView(code) {
  ...
  const examination = examRows.length
    ? examKeys.reduce((acc, k) => {
        acc[k] = Math.round(
          examRows.reduce(
            (a, r) => a + (r.examinationDistribution[k] || 0),
            0,
          ) / examRows.length,
        );
        return acc;
  ...
  return {
    ...
    happyTookPercent: happyRows.length
      ? Math.round(
          (100 * happyRows.filter((r) => r.happyTook).length) /
            happyRows.length,
        )
      : null,
...
export function examinationSegments(distribution, locale) {
  ...
  return EXAMINATION_KEYS.filter((k) => (distribution[k] || 0) > 0).map(
    (k) => ({
      key: k,
      label: labels[k],
      percent: distribution[k],
      color: EXAMINATION_COLORS[k],
      ink: EXAMINATION_INK[k],
    }),
  );
}
...
export function catalogCardView(code, opts) {
  ...
  return {
    ...
    prereq: prerequisitesOf(code, o.locale)
      .map((p) => p.code)
      .join(", "),
    eligibility: course.eligibility,
    summary: course.content,
    ...
    happyAnswerCount:
      raw.happyAnswerCount != null ? raw.happyAnswerCount : null,
    stats: [
...
export const catalogCards = (opts) =>
  courses.map((c) => catalogCardView(c.code, opts)).filter(Boolean);
...
export function takenView(row, opts) {
  const o = opts || {};
  const view = row.courseCode
    ? courseView(row.courseCode, {
        locale: o.locale,
        startTerm: row.attendanceYear,
      })
    : null;
  return {
    ...
    grade: row.grade,
    attendanceTerm:
      row.attendanceYear != null
        ? String(yearOf(row.attendanceYear) || "")
        : null,
    ...
    conflict:
      row.conflict || (row.courseCode && !view ? "unknown-course" : null),
  };
}

export const reviewsByUser = (userId) =>
  reviews.filter((r) => r.userId === userId);
export const reviewsByCourse = (code) =>
  reviews.filter((r) => r.courseCode === code);

export const takenRecord = (userId, code) =>
  userTakenCourses.find((r) => r.userId === userId && r.courseCode === code) ||
  null;
...
export function reviewView(review, opts) {
  ...
  return {
    ...
    startTermLabel: String(
      yearOf(taken ? taken.attendanceYear : fallbackTerm) || "",
    ),
...
export function resolveHarness(props) {
  const p = props || {};
  const session =
    p.session === "member" || p.session === "guest"
      ? p.session
      : sessionStore.read();
  const scenario =
    SCENARIOS.indexOf(p.scenario) >= 0 ? p.scenario : scenarioStore.read();
  return {
    session,
    scenario,
